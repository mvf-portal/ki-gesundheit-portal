        ...
        "studies": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    # Versorgungskontext und Regulierungsrahmen gleichermassen.
...
def fetch_pubmed() -> str:
    ...
    Die allgemeine Abfrage allein reicht nicht. Digitalisierung und KI in der
    Medizin werden weltweit publiziert, mit starkem Uebergewicht der USA und
    Chinas; die tagesaktuellen Neuaufnahmen sind entsprechend dominiert. Fuer
    eine deutsche Leserschaft zaehlt aber, was in einem Sozialversicherungs-
    system mit EU-Regulierung gilt - Zulassungsweg, Erstattung und Datenschutz
    unterscheiden sich grundlegend.

    Deshalb stellt die Europa-Abfrage die MEHRHEIT des Pools und steht vorn:
    Ein Sprachmodell gewichtet, was es zuerst liest.
    """
